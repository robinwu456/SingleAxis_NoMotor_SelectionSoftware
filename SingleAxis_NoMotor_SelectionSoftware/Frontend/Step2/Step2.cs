...
namespace SingleAxis_NoMotor_SelectionSoftware {
    public class Step2 {
        ...
        public Step2(FormMain formMain) {
            ...
            formMain.explorerBarPanel2.Size = new Size(formMain.explorerBarPanel2.Size.Width, minHeight);
        ...
        private void CmdCalc_Click(object sender, EventArgs e) {
            ...
            //curRecommandList = new List<Model>();
            //curRecommandList.Add(new Model() {
            //    name = "GTH8S",
            //    lead = 10,
            //    load = 100,
            //    rpm = 3000,
            ...
            //    moment_C = 0,
            //    usePower = 400,
            //    tMaxSafeCoefficient = 36.54,
            //    tRmsSafeCoefficient = 24.42,
            //});
            ...
            //formMain.dgvRecommandList.Columns["dgvRecommandColumnModel"].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
        }
