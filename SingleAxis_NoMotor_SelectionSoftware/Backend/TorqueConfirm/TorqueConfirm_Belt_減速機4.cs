...
namespace SingleAxis_NoMotor_SelectionSoftware {
    public class TorqueConfirm_Belt_減速機4 : TorqueConfirm_Belt_減速機 {
        private Model model;
        ...
        public override void MotorConfirm() {
            ...
            model.rotateInertia_total = model.rotateInertia_load + model.rotateInertia_belt + model.reducerRotateInertia + model.mainWheel_P1.rotateInertia + model.subWheel_P2.rotateInertia + model.subWheel_P3.rotateInertia + model.subWheel_P4.rotateInertia;
