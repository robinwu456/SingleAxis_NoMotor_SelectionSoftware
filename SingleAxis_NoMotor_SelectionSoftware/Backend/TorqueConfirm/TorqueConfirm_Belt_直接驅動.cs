...
namespace SingleAxis_NoMotor_SelectionSoftware {
    public class TorqueConfirm_Belt_直接驅動 : TorqueConfirm_Belt {
        ...
        public override void MotorConfirm() {
            ...
            model.rotateInertia_total = model.rotateInertia_load + model.rotateInertia_belt + model.subWheel2.rotateInertia + model.subWheel3.rotateInertia;
        ...
        public override void MotorTorqueConfirm() {
            ...
            model.forceTorque_accel = model.forceTotal_accel * ((model.subWheel2.diameter / 2) / 1000);
            model.torqueTotal_accel = model.inertialTorque_accel + model.forceTorque_accel;

            // 等速區扭矩
            model.inertialTorque_constant = 0;
            model.forceTorque_constant = model.forceTotal_constant * ((model.subWheel2.diameter / 2) / 1000);
            ...
            model.forceTorque_decel = model.forceTotal_decel * ((model.subWheel2.diameter / 2) / 1000);
            model.torqueTotal_decel = model.inertialTorque_decel + model.forceTorque_decel;

            // 停置區扭矩
            model.inertialTorque_stop = 0;
            model.forceTorque_stop = model.forceTotal_stop * ((model.subWheel2.diameter / 2) / 1000);
